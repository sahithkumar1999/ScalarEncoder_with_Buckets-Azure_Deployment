...
namespace NeoCortexApi.Encoders
{
    ...
    /// </summary>
    public class NewScalarEncoder : EncoderBase
    {
        private int v1;
        private int v2;
        private int v3;
        ...
        public NewScalarEncoder(Dictionary<string, object> encoderSettings)
        {
            this.Initialize(encoderSettings);
        }

        public NewScalarEncoder(int v1, int v2, int v3, bool v4)
        {
            this.v1 = v1;
            this.v2 = v2;
            this.v3 = v3;
